...
class CatalogTable extends Component {
    ...
    renderItem(items){
        return items.map((item, index) => {
            console.log(item.asset_images[0]);
            if(item.asset_images[0] ===  undefined){
                return (
                    <tr key={item.id}>
                        <td>
                            <div className="icon">
                                <div className="edit" onClick={this.props.updatePopup.bind(this, item)}>
                                ...
                                <div className="delete" onClick={this.props.deleteItem.bind(this, item)}>
